...
---------------------- INPUT FILES ---------------------------------------------
"../1.5_MW_Modules/WP_VSP_WTurb_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"unused"      BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"unused"      BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"unused"      BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"../1.5_MW_Modules/WP_Baseline_InflowWind_12mps.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"../1.5_MW_Modules/WP_Baseline_AeroDyn15_Dynin.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"../1.5_MW_Modules/WP_VSP_WTurb_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
